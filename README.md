...
I am a graduate student forging connections between structured graph knowledge and heterogeneous data modalities (Text, Image, etc.). My research focuses on complex data reasoning through **Multimodal Knowledge Graphs**.
</blockquote>

```text
- 🔬 RESEARCH: Multimodal KGC, Cross-Modal Reasoning.
- 🛠️ WORKFLOW: VS Code // Linux (tmux) // LaTeX // Alibaba Cloud.
